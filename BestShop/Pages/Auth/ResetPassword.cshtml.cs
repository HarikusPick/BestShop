...
namespace BestShop.Pages.Auth
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        [Compare("Password", ErrorMessage = "Password and Confirm Password do not match")] //passwordlarýn eþleþmesi kontrolu
        ...
        public void OnPost()
        {
            ...
            try
            {
                ...
                {
                    connection.Open();
                    //1)check the token is valid, and reset pw
                    string email = "";
                    ...
                    //3)delete the token from database -> password_resets table
