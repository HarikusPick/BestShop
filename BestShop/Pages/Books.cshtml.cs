...
{
    [BindProperties(SupportsGet = true)] //arama yaptýktan sonra arama inputlarýnýn dolu kalmasý için true yapýldý.
    public class BooksModel : PageModel
    {
        ...
        public int page = 1; //þuanki html sayfasý
        public int totalPages = 0;
        private readonly int pageSize = 5; // saydafadaki kitap adeti
