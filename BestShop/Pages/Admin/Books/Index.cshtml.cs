...
namespace BestShop.Pages.Admin.Books
{
        ...
        public void OnGet()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    {
                        command.Parameters.AddWithValue("@search", "%" + search + "%"); //*1
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                bookInfo.CreatedAt = reader.GetDateTime(9).ToString("dd/MM/yyyy");
 ...
 /*1
                         @search parametresi, SQL sorgusunda yerine geçecek bir parametredir. 
                        search deðiþkeni, arama sorgusunda kullanýlacak olan deðeri temsil eder. 
                        + operatörü, search deðerini % karakterleriyle birleþtirir. Bu, arama deðerinin
                        her iki tarafýna da joker karakterler eklenerek, arama deðerinin içinde geçen 
                        karakterlere sahip kayýtlarý bulmayý saðlar.
                         */